...
const BUILD = "phase-9.1";
const CACHE = "campfire-" + BUILD;
const SHELL = ["./", "./index.html", "./manifest.webmanifest",
               "./icon-192.png", "./icon-512.png", "./icon-maskable-512.png"];

self.addEventListener("install", e => {
  /* addAll is all-or-nothing: a single 404 (a mistyped upload, say) would
     silently leave the app with no offline cache at all. Cache what exists. */
